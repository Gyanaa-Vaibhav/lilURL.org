...
type ShowPasswordIconButtonType = {
    showingPassword: boolean,
    setShowingPassword: (value: React.SetStateAction<boolean>) => void
}

export function ShowPasswordIconButton({showingPassword,setShowingPassword}:ShowPasswordIconButtonType){
    return showingPassword ?
        <button
            onClick={() => setShowingPassword(i => !i)}
